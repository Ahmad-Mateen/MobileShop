...
@section('content')
        ...
        <div class="container-fluid py-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm " aria-current="page">Banner list</li>
                </ol>
            </nav>
        </div>
    </nav>
    ...
    <div class="row">
        <div class="text-center d-flex flex-row-reverse">
            <a href="{{route('admin.banner.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i>Add Banner</a>
        </div>
